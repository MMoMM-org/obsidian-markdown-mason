...
- [Installation](docs/installation.md) — TODO: Walk a first-time user through installing Markdown Mason, verifying it loaded, and knowing when to update.
- [Configuration](docs/configuration.md)
- [Usage](docs/usage.md)
- [Troubleshooting](docs/troubleshooting.md) — TODO: Help a user recover from the most common failure modes, written from the symptom they observe rather than the internal cause.
- [Commands Reference](docs/commands-reference.md) — TODO: List every command Markdown Mason contributes to the Obsidian command palette, with a one-line description and any preconditions.
- [Release process](docs/RELEASE.md)
- [Writing a Markdown Mason script](docs/SCRIPT_AUTHORING.md)
- [Settings Reference](docs/settings-reference.md) — TODO: Provide a deep, hand-authored reference for every exposed setting — allowed values, interactions, and when to change each one.
