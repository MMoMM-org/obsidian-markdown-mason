...
- [x] **T1.2 Manifest & compliance baseline** `[activity: build-tooling]`
...
- [x] **T1.3 Plugin lifecycle skeleton** `[activity: backend-api]`
...
- [x] **T1.4 Test harness & fixtures wiring** `[activity: testing]`
