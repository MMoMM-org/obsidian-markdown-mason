...
- [x] **T7.1 End-to-end happy path** `[activity: testing]`
...
- [x] **T7.2 Invariant & failure-mode suite** `[activity: testing]`
...
- [x] **T7.3 EARS acceptance trace** `[activity: validate]`
...
- [x] **T7.4 Release readiness** `[activity: build-tooling]`
...
- [x] **T7.5 Sync verification spike (manual)** `[activity: research]`
...
- [x] **T7.6 Phase Validation** `[activity: validate]`
