...
- [ ] **T3.2 applyEditPlan — atomic CM6 transaction** `[activity: backend-api]`
...
- [ ] **T3.3 Source adapters: selection & whole-note** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T3.4 Standalone Mason: commands + Notices/undo** `[activity: backend-api]`
