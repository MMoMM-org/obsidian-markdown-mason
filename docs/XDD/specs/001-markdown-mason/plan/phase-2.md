...
- [ ] **T2.1 Core types** `[activity: domain-modeling]`
...
- [ ] **T2.2 URL normalization** `[activity: domain-modeling]` `[parallel: true]`
...
- [ ] **T2.3 Heading cascade + normalize (H)** `[activity: domain-modeling]` `[parallel: true]`
...
- [ ] **T2.4 Footnote identity — fused O+D** `[activity: domain-modeling]` `[parallel: true]`
