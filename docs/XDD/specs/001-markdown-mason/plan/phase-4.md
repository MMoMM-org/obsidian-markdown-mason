...
- [ ] **T4.1 Parser interface** `[activity: domain-modeling]`
...
- [ ] **T4.2 perplexity-app parser** `[activity: domain-modeling]` `[parallel: true]`
...
- [ ] **T4.3 perplexity-web parser** `[activity: domain-modeling]` `[parallel: true]`
...
- [ ] **T4.4 perplexity-web-download parser** `[activity: domain-modeling]` `[parallel: true]`
...
- [ ] **T4.5 Format detector (auto-dispatcher)** `[activity: domain-modeling]`
